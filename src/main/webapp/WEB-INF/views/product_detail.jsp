  ...
  <head>
    ...
    <![endif]-->--%>
     ...
     <%-- <link href="/Shopping/css/bootstrap.min.css" rel="stylesheet">
      ...
      <script src="/Shopping/js/bootstrap.min.js" type="text/javascript"></script>
      <script src="/Shopping/js/layer.js" type="text/javascript"></script>
      <link id="layuicss-skinlayercss" href="http://120.79.92.126/Shopping/js/skin/default/layer.css?v=3.0.11110" rel="stylesheet">
      <!--[if lt IE 9]>
      <script src="/Shopping/js/html5shiv.min.js"></script>
      <script src="/Shopping/js/respond.min.js"></script>
      <![endif]-->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 col-md-5">
                    <img class="detail-img" src="/Shopping/img/${productDetail.id}.jpg">
                </div>
 ...
 <script type="text/javascript">
      ...
      function addToShoppingCar(productId) {
          ...
          if(addResult == "success") {
              layer.confirm('前往购物车？', {icon: 1, title:'添加成功',btn:['前往购物车','继续浏览']},
                      function(){
                          window.location.href = "/Shopping/shopping_car";
                      },
                      function(index){
                        layer.close(index);}
              );
      ...
      function addToShoppingRecords(productId) {
          ...
          $.ajax({
              async : false,
              type : 'POST',
              url : '/Shopping/addShoppingRecord',
              data : shoppingRecord,
              dataType : 'json',
              success : function(result) {
      ...
      function getUserProductRecord() {
          ...
          $.ajax({
              async : false, //设置同步
              type : 'POST',
              url : '/Shopping/getUserProductRecord',
              data : product,
              dataType : 'json',
              success : function(result) {
      ...
      function getEvaluations() {
          ...
          $.ajax({
              async : false, //设置同步
              type : 'POST',
              url : '/Shopping/getShoppingEvaluations',
              data : product,
              dataType : 'json',
              success : function(result) {
      ...
      function addToEvaluation() {
          ...
          $.ajax({
              async : false,
              type : 'POST',
              url : '/Shopping/addShoppingEvaluation',
              data : evaluation,
              dataType : 'json',
              success : function(result) {
                  addResult = result.result;
