...
<script type="text/javascript">
    ...
    function getAllShoppingRecords() {
        ...
        $.ajax({
            async : false, //设置同步
            type : 'POST',
            url : '/Shopping/getAllShoppingRecords',
            data : nothing,
            dataType : 'json',
    ...
    function sendProducts(userId,productId,time) {
        ...
        if(sendResult == "success")
            window.location.href = "/Shopping/shopping_handle";
    }
</script>
...
<%--<script type="text/javascript">
    ...
    function judgeIsLogin() {
        if("com.shopping.entity.User@829c2a" == null || "com.shopping.entity.User@829c2a" == undefined || "com.shopping.entity.User@829c2a" ==""){
            window.location.href = "/Shopping/login";
        }
    }
